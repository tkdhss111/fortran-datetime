program main
  ...
  dts = seq_dt ( dt_fr = strptime ('2020-07-01 00:00:00'), dt_to = strptime ('2020-07-01 15:00:00'), by = '30 mins' )

  do i = 1, size(dts)

    print *, 'dts', i, dts(i)%datetime
...
stop
  ...
  datetimes = get_datetime ( yr0=[2020, 2012], sc0=[20, 30] ) 
  dts = strptime ( datetimes )
  print '(*(1x, a19))',       "datetime : ", [(dts(i)%datetime,  i = 1, n)]
  print '(a)', ''
  ...
  print '(a)', repeat('-', 79)
  print '(*(1x, a19))',       "datetime : ", [(datetimes(i), i = 1, n)]
