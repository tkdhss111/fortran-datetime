! Last updated @date 2024-09-26
!========================================================
! Date and Time Fortran Module
! 
! @brief 
!  Almost pure elemental procesure for datetime handling
!
...
module dt_mo
  ...
  !integer,      parameter :: LEAPYEARS(11)  = [2000, 2004, 2008, 2012, 2016, 2020, 2024, 2028, 2032, 2036, 2040] ! not fast!
...
contains
  ...
  pure function seq_dt ( dt_fr, dt_to, by ) result ( dts )
    ...
    dts = strptime ( cts )
    ! N.B. The following implementation causes segmentation fault for some reaason in make_weights_mo of 01_forecasting_tools
